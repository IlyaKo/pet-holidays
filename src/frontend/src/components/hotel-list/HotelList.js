  ...
  return (
    <>
      ...
      <div className="container is-fluid">
        ...
        <button onClick={() => setIsFormVisible(!isFormVisible)} className="button is-primary is-fullwidth"> {isFormVisible ? "Cancel" : "Add Hotel"} </button>
          ...
          <form onSubmit={handleAddHotel} className="box">
            ...
            <div className="field">
              ...
              <div className="control">
                <input className="input"  value={newHotelName} onChange={(e) => setNewHotelName(e.target.value)} required placeholder="Enter hotel name"/>
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="control">
                <textarea className="textarea" value={newHotelDescription} onChange={(e) => setNewHotelDescription(e.target.value)} required placeholder="Enter hotel description" autoComplete="off"/>
              </div>
            </div>
        ...
        {hotels.map((hotel) => (
          <div className="card" key={hotel.id}>
            ...
            <div className="buttons">
              <button onClick={() => toggleEditForm(hotel.id)} className="button is-warning"> Edit</button>
