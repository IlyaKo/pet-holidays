    ...
    <form onSubmit={handleSubmit} className="box">
      ...
      <div className="field">
        ...
        <div className="control">
          <input className="input" type="text" value={name} onChange={(e) => setName(e.target.value)} required placeholder="Enter hotel name" autoComplete="off" />
        </div>
      </div>
      ...
      <div className="field">
        ...
        <div className="control">
          <textarea className="textarea" value={description} onChange={(e) => setDescription(e.target.value)} required placeholder="Enter hotel description" autoComplete="off" />
        </div>
      </div>
